...
$handle11 = fopen("valorn/canal20.txt", "r");
if ($handle11) {
...
<script type="text/javascript">
	...
	function drawChart11() {
		...
		var chart = new google.visualization.LineChart(document.getElementById('curve_chart20n'));
		chart.draw(data, options);
	}
	
	google.charts.setOnLoadCallback(drawChart11);
</script>
<div id="curve_chart20n" class="grafico"></div>
